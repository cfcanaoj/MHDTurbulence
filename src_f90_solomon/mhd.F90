...
DECLARE_OFFLOADED(AS_SEQUENTIAL)
...
PRAGMA_ACC_KERNELS()
PRAGMA_ACC_LOOP(COLLAPSE(2), AS_INDEPENDENT, AS_PRIVATE(i, Pleftc1, Pleftc2, Plefte,Prigtc1, Prigtc2, Prigte,dsv,dsvp,dsvm,etot,ptl,css,cts,leftco,rigtco,nflux))
      do k=ks,ke
      do j=js,je
      do i=is,ie+1
         Pleftc1(:) = svc(:,i-2,j,k)
...
PRAGMA_ACC_KERNELS()
PRAGMA_ACC_LOOP(COLLAPSE(2), AS_INDEPENDENT, AS_PRIVATE(j, Pleftc1, Pleftc2, Plefte,Prigtc1, Prigtc2, Prigte,dsv,dsvp,dsvm,etot,ptl,css,cts,leftco,rigtco,nflux))
      do k=ks,ke
      do i=is,ie
      do j=js,je+1
         Pleftc1(:) = svc(:,i,j-2,k)
...
PRAGMA_ACC_KERNELS()
PRAGMA_ACC_LOOP(COLLAPSE(2), AS_INDEPENDENT, AS_PRIVATE(k, Pleftc1, Pleftc2, Plefte,Prigtc1, Prigtc2, Prigte,dsv,dsvp,dsvm,etot,ptl,css,cts,leftco,rigtco,nflux))
      do j=js,je
      do i=is,ie
      do k=ks,ke+1
